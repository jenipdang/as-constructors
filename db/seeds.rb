...
puts "🌱 Creating users..."
matt = User.create(name: "Matt Chavez", email: "mattchavez@gmail.com", city: "LA", state: "CA")
jennifer = User.create(name: "Jennifer Cruz", email: "jennifer19@yahoo.com", city: "Chicago", state: "IL")
chris = User.create(name: "Chris Vu", email: "chrisVu@gmail.com", city: "NYC", state: "NYC")
francis = User.create(name: "Francis Dang", email: "srBark2015@gmail.com", city: "San Jose", state: "CA")
beto = User.create(name: "Beto Alvarez", email: "beto2012@gmail.com", city: "Monterey Park", state: "CA")
sophie = User.create(name: "Sophie Nguyen", email: "sophie-ng@gmail.com", city: "Garden Grove", state: "CA")
...
Suggestion.create(title: "Tankless Water Heater", description: "The EcoSmart Tankless Water Heater gives you 2x more hot water, save space and save money.", user_id: beto.id)
